...
class TestLoader:
    ...
    def discover(
        self, start_dir: str, pattern: str = "temp*.py", top_level_dir: str | None = None
...
if sys.version_info < (3, 13):
    ...
    @deprecated("Deprecated in Python 3.11; removal scheduled for Python 3.13")
    def findTestCases(
        module: ModuleType, prefix: str = "temp", sortUsing: _SortComparisonMethod = ..., suiteClass: _SuiteClass = ...
    ) -> unittest.suite.TestSuite: ...
