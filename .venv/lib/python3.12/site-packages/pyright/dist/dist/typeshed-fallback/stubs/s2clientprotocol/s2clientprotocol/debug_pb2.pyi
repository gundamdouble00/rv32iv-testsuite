...
class DebugTestProcess(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["delay_ms", b"delay_ms", "temp", b"temp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["delay_ms", b"delay_ms", "temp", b"temp"]) -> None: ...
